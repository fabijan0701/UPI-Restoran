...
{
    /// <summary>
    /// Forma koja služi za unos podataka o gostu i stolovima koje gost rezervira
    /// </summary>
    public partial class NewReservationForm : Form
    {
        ...
        public NewReservationForm((DateTime, DateTime) vrijemeRezervacije)
        {
            InitializeComponent();
        ...
        private void NewReservation()
        {
            ...
            Rezervacija r = new Rezervacija(g, stol, vrijemeRezervacije.Item1, vrijemeRezervacije.Item2, kontakt);
            Rezervacija = r;
            Done = true;
        }
        ...
        private void btnSpremi_Click(object sender, EventArgs e)
        {
            ...
            {
                Close();
                Project.TimeSelection_Form.Close();
            }
        }
